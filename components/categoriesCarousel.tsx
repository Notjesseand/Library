  ...
  return (
    ...
    >
      {categories.map((item, index) => (
        ...
        >
          <div className="relative group h-44 sm:h-56 bg-gray-500 bg-cover w-48 sm:w-5/6 bg-center mx-auto rounded-md overflow-hidden transition-opacity duration-300">
